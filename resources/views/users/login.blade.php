    ...
    <div class="h-full w-[100%]">
        <div id="default-styled-tab-content">
            <div class="rounded-lg bg-gray" id="styled-settings" role="tabpanel" aria-labelledby="settings-tab">
                ...
                <!-- Form -->
                <form method="POST" action="{{ route('users.login.submit') }}" class="max-w-sm mx-auto mt-10 flex flex-col">
                    @csrf
                    ...
                    <!-- Username Field -->
                    <div class="mb-5">
                        <label for="username" class="block mb-2 text-sm font-medium text-gray-900">Username {{ Auth::guard('users')->id() }}</label>
                    ...
                    <div class="mt-4 text-center">
                        ...
                        <a href="/users/register" class="text-blue-600 hover:text-blue-800 font-semibold">Daftar</a>
                    </div>
                </form>
            </div>
        </div>
